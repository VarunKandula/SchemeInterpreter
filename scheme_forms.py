...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # BEGIN PROBLEM 4
        evalExp = scheme_eval(expressions.rest.first, env)
        env.define(signature, evalExp)
        return signature
        # END PROBLEM 4
        ...
        evalExp = do_lambda_form(Pair(signature.rest, body), env)
        env.define(name, evalExp)
        return name
